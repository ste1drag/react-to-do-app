...
class AddToDo extends React.Component{
    ...
    render(){
        return(
            <div style={{backgroundColor:'#C0BAFA', width:'450px', padding:'15px'}}>
                <h1 style={{fontSize:'35px',color:'#662CF4',font:'Arial'}}>Unesi naslov</h1>
                <input type="text" value={this.props.title} onChange={this.onChangeTitle} placeholder="Dodaj naslov" style={{width: '400px',maxWidth: '100%',backgroundColor:'#EAFAEC',padding: '10px 10px',fontSize:'25px'}} />
                <h1 style={{fontSize:'35px',color:'#662CF4',font:'Arial'}}>Dodaj task</h1>
                <textarea name="taskId" id="taskId" cols="24" rows="10"  onChange={this.onChangeTask} placeholder="Unesi task" style={{maxWidth: '100%',backgroundColor:'#EAFAEC',borderRadius:'8%',fontSize:'30px'}}></textarea>
                <br />
